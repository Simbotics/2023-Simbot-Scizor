...
public final class FieldConstants {
  ...
  // TODO we need to move the positions to be where the robot -should- be and not where the april
  // tags actually are

  public static Pose2d[] BlueCubeScoringList =
      new Pose2d[] {
        BlueCubeScoringLocations.Blue2.pos,
        BlueCubeScoringLocations.Blue5.pos,
        BlueCubeScoringLocations.Blue8.pos
      };

  public static Pose2d[] RedCubeScoringList =
      new Pose2d[] {
        RedCubeScoringLocations.Red2.pos,
        RedCubeScoringLocations.Red5.pos,
        RedCubeScoringLocations.Red8.pos
      };

  public static Pose2d[] BlueConeScoringList =
      new Pose2d[] {
        BlueConeScoringLocations.Blue1.pos,
        BlueConeScoringLocations.Blue3.pos,
        BlueConeScoringLocations.Blue4.pos,
        BlueConeScoringLocations.Blue6.pos,
        BlueConeScoringLocations.Blue7.pos,
        BlueConeScoringLocations.Blue9.pos,
      };

  public static Pose2d[] RedConeScoringList =
      new Pose2d[] {
        RedConeScoringLocations.Red1.pos,
        RedConeScoringLocations.Red3.pos,
        RedConeScoringLocations.Red4.pos,
        RedConeScoringLocations.Red6.pos,
        RedConeScoringLocations.Red7.pos,
        RedConeScoringLocations.Red9.pos,
      };

  public static Pose2d[] RedHumanLoadingList =
      new Pose2d[] {RedHumanLoadingLocations.RedLeft.pos, RedHumanLoadingLocations.RedRight.pos};

  public static Pose2d[] BlueHumanLoadingList =
      new Pose2d[] {
        BlueHumanLoadingLocations.BlueLeft.pos, BlueHumanLoadingLocations.BlueRight.pos
      };

  public enum BlueCubeScoringLocations {
    Blue2(
        new Pose2d(
            Units.inchesToMeters(70.0),
    ...
    Blue8(
        new Pose2d(
            Units.inchesToMeters(70.0),
            Units.inchesToMeters(-42.19), // FIRST's diagram has a typo (it says 147.19)
            new Rotation2d(Math.toRadians(180.0))));

    public final Pose2d pos;

    private BlueCubeScoringLocations(Pose2d pos) {
      this.pos = pos;
    }
  }

  public enum BlueConeScoringLocations {
    Blue1(
        new Pose2d(
            Units.inchesToMeters(70.0),
    ...
    Blue9(
        new Pose2d(
            Units.inchesToMeters(70.0),
            Units.inchesToMeters(-20.19), // FIRST's diagram has a typo (it says 147.19)
            new Rotation2d(Math.toRadians(180.0))));

    public final Pose2d pos;

    private BlueConeScoringLocations(Pose2d pos) {
      this.pos = pos;
    }
  }

  public enum BlueHumanLoadingLocations {
    BlueLeft(
        new Pose2d(
            Units.inchesToMeters(597.25),
            Units.inchesToMeters(-286.74),
            new Rotation2d(Math.toRadians(0.0)))),
    BlueRight(
        new Pose2d(
            Units.inchesToMeters(597.25),
            Units.inchesToMeters(-244.74),
            new Rotation2d(Math.toRadians(0.0))));

    public final Pose2d pos;

    private BlueHumanLoadingLocations(Pose2d pos) {
      this.pos = pos;
    }
  }

  public enum RedCubeScoringLocations {
    Red2(
        new Pose2d(
            Units.inchesToMeters(581.25),
            Units.inchesToMeters(-42.19),
            new Rotation2d(Math.toRadians(0.0)))),
    Red5(
        new Pose2d(
    ...
    private RedCubeScoringLocations(Pose2d pos) {
      this.pos = pos;
    }
  }

  public enum RedConeScoringLocations {
    Red1(
        new Pose2d(
            Units.inchesToMeters(581.25),
    ...
    Red9(
        new Pose2d(
            Units.inchesToMeters(581.25),
            Units.inchesToMeters(-196.19), // FIRST's diagram has a typo (it says 147.19)
            new Rotation2d(Math.toRadians(0.0))));

    public final Pose2d pos;

    private RedConeScoringLocations(Pose2d pos) {
      this.pos = pos;
    }
  }

  public enum RedHumanLoadingLocations {
    RedLeft(
        new Pose2d(
    ...
    private RedHumanLoadingLocations(Pose2d pos) {
      this.pos = pos;
    }
  }
}
