...
/**
 * This class wraps {@link SimSwerveDriveOdometry Swerve Drive Odometry} to fuse latency-compensated
 * vision measurements with swerve drive encoder distance measurements. It is intended to be a
 * drop-in replacement for {@link edu.wpi.first.math.kinematics.SimSwerveDriveOdometry}.
 *
 * <p>{@link SimSwerveDrivePoseEstimator#update} should be called every robot loop.
 *
 * <p>{@link SimSwerveDrivePoseEstimator#addVisionMeasurement} can be called as infrequently as you
 * want; if you never call it, then this class will behave as regular encoder odometry.
 */
public class SimSwerveDrivePoseEstimator {
  private final SwerveDriveKinematics m_kinematics;
  private final SimSwerveDriveOdometry m_odometry;
  ...
  /**
   * Constructs a SimSwerveDrivePoseEstimator with default standard deviations for the model and
   * vision measurements.
   *
   ...
   */
  public SimSwerveDrivePoseEstimator(
  ...
  /**
   * Constructs a SimSwerveDrivePoseEstimator.
   *
   * @param kinematics A correctly-configured kinematics object for your drivetrain.
   * @param gyroAngle The current gyro angle.
  ...
  public SimSwerveDrivePoseEstimator(
    ...
    m_odometry =
        new SimSwerveDriveOdometry(kinematics, gyroAngle, modulePositions, initialPoseMeters);
  ...
  public void overrideAngle(double angle) {
    m_odometry.overrideAngle(angle);
  }
   ...
   * SimSwerveDrivePoseEstimator#update} every loop.
   *
   ...
   *     SimSwerveDrivePoseEstimator#updateWithTime(double,Rotation2d,SwerveModulePosition[])} then
   ...
   * SimSwerveDrivePoseEstimator#setVisionMeasurementStdDevs(Matrix)} or this method.
   *
   * @param visionRobotPoseMeters The pose of the robot as measured by the vision camera.
   * @param timestampSeconds The timestamp of the vision measurement in seconds. Note that if you
   *     don't use your own time source by calling {@link
