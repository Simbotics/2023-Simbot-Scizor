 ...
 */
public class SimSwerveDriveOdometry {
  ...
  /**
   * Constructs a SimSwerveDriveOdometry object.
   *
  ...
  /**
   * Constructs a SimSwerveDriveOdometry object with the default pose at the origin.
   *
   * @param kinematics The swerve drive kinematics for your drivetrain.
   * @param gyroAngle The angle reported by the gyroscope.
   * @param modulePositions The wheel positions reported by each module.
  ...
  public void overrideAngle(double angle) {
    ...
    this.m_poseMeters = new Pose2d(this.m_poseMeters.getTranslation(), new Rotation2d(angle));
  }
