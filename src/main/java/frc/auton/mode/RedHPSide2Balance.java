...
// Cone, Cube, Cone
public class RedHPSide2Balance implements AutonMode {
  ...
  public void addToMode(AutonBuilder ab) {
    ...
    AutonGroups.PreloadCommands.SCORE_MID_CONE.addToAutonBuilder(ab);
    ...
    AutonGroups.TwoAndBalanceCommands.DRIVE_AND_BALANCE.addToAutonBuilder(ab);
  }
}
