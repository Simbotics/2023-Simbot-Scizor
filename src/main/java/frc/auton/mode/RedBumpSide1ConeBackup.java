 ...
 * @author Michael
 */
public class RedBumpSide1ConeBackup implements AutonMode {
  ...
  public void addToMode(AutonBuilder ab) {
    ...
    ab.addCommand(new DriveToPoint(-4.2, 0, 180.0, 0.0, 0.6, 0.2, 0.05, 5000));
    ...
    ab.addCommand(new DriveToPoint(-4.75, 0, 180.0, 0.0, 0.3, 0.2, 0.08, 5000));
    ab.addCommand(new DriveWait());
    ...
    ab.addCommand(new DriveToPoint(-1.0, 0, 0.0, 0.0, 0.3, 0.5, 0.05, 5000));
    ab.addCommand(new DriveWait());
  }
}
