...
// Cone, Cube, Cone
public class BlueBumpSide3PieceStemley implements AutonMode {
  ...
  public void addToMode(AutonBuilder ab) {
    ...
    ab.addCommand(
        new DriveSetPosition(
            false,
            FieldConstants.BlueConeScoringLocations.Blue9.pos.getX() + 2.53,
            FieldConstants.BlueConeScoringLocations.Blue9.pos.getY(),
            FieldConstants.BlueConeScoringLocations.Blue9.pos.getRotation().getDegrees()));
